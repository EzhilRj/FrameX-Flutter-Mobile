...
public class Login_Module extends AppiumTestSetup {
	...
	public static boolean Login_in_App(String Username, String Password, String project, String Mobileno)
			throws Exception {
		...
		try {
			...
			if (Source("Please Enter a valid UserName and Password and try again.....")
					|| Source("Please enter a valid Project Name and try again.")) {
				...
				return true;
			} else if (Source("Username is Required") || Source("Password is Required|")|| Source("Project is Required") || Source("Mobile Number is Required")) {
				testReport.get().fail(formatData("Negative data is given : Login was not successful. "));
				log.error("Login failed");
