...
public class ResourceCentreTest {
    ...
    @Test(dataProviderClass = Utils.class, dataProvider = "Testdatas",priority = 6,description = "This  test case verifies the all type of extension files is downloaded or not .")
